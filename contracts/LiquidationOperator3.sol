...
contract LiquidationOperator3 is IUniswapV2Callee {
    ...
    IUniswapV2Pair immutable uniswapV2Pair_WETH_USDC;
    ...
    constructor() {
        ...
        uniswapV2Pair_WETH_USDC = IUniswapV2Pair(uniswapV2Factory.getPair(address(WETH), address(USDC)));
    ...
    function operate(uint256 debt_USDC_input) external {
    ...
    function uniswapV2Call(
        ...
        (uint256 reserve_USDC_Pool1, uint256 reserve_WETH_Pool1, ) = uniswapV2Pair_WETH_USDC.getReserves();

        // 2.1 liquidate the target user

        console.log("flash loan: %s", USDC.balanceOf(address(this))); 
        ...
        console.log("collateral_WETH: ",collateral_WETH);
